...
<body>
      ...
      <p>Please use the form below to place a Reservation. Use the calendar provided to select the number of days you wish to reserve.</p>
        ...
        <form action="process_registration.php" method="post">
          ...
          Email:<br><input type="text" name="email" value="kidandim@gmail.com" required="required"><br><br>
          Nationality:<br>
          ...
          <br><br>
          Phone:<br><input type="text" name="phone" value="+256773954873" required="required"><br><br>
